              ...
              children: notifications.isEmpty
                  ...
                  : List.generate(
                      ...
                      (index) => GestureDetector(
                        // onTap: () {},
                        onTap: () => notifications[index].type == "friend"
                            ? context.pushNamed("UserId", pathParameters: {
                                "id": notifications[index].from['_id']
                              })
                            : context.pushNamed("PostId", pathParameters: {
                                "id": notifications[index].post['_id']
                              }),
                        child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                CachedNetworkImage(
                                  width: 70,
                                  height: 70,
                                  imageUrl: notifications[index].from['avatar']
                                          ['url'] ??
                                      "",
